...
export default function ReviewHeader() {
  ...
  return (
    <div className="self-stretch inline-flex justify-start items-center flex-wrap content-center"  style={{ marginTop: 20, marginLeft: 100 }}>
      ...
      <div className="flex-1 min-w-[500px] p-2.5 flex justify-start items-start gap-2.5" style={{marginLeft: 30}}>
