            ...
            >
              ...
              <div className="flex items-center justify-end gap-3 p-4 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`px-4 py-2 text-white ${styles.confirmBg} rounded-lg transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2`}
                >
                  {isLoading && (
